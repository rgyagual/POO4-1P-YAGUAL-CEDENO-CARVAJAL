...
public class Aficionado extends Usuario {
     ...
     * @return               La nueva compra realizada o null si no hay entradas disponibles para esa zona.
     */
    public Compra comprar(Partido partido, Zona zona, int cantidad, String numeroTarjeta) {
        ...
        switch (zona) {
            case GENERAL:
                ...
                precioEntrada = partido.getPrecioGeneral();
                break;
            case PREFERENCIAL:
                entradasDisponibles = partido.getEntradaPreferencial();
                precioEntrada = partido.getPrecioPreferencial();
                break;
            case VIP:
                entradasDisponibles = partido.getEntradaVip();
                precioEntrada = partido.getPrecioVip();
                break;
        }
